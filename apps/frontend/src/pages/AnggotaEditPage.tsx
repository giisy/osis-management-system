...
import { useUpdateAnggota, useDeleteAnggota } from '../features/anggota/useAnggotaMutation'
...
export default function AnggotaEditPage() {
  ...
  const handleDelete = () => {
    ...
    const confirmed = window.confirm(
      `Yakin ingin menghapus anggota "${data?.data.name}"? Tindakan ini tidak bisa dibatalkan.`
    )
    if (!confirmed) return
